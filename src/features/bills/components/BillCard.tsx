...
export default function BillCard({
  ...
  return (
    <Card className="group flex flex-col transition-all duration-300 hover:shadow-card hover:-translate-y-1 overflow-hidden bg-glass-card border-border/40 relative">
